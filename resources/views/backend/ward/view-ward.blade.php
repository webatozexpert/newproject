            ...
            <section class="content">
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="title-header text-center">Ward List</h3>
                        <h3>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                               ...
                                                               <td>{{$ward ['upazila']['name']}}</td>
                                                                ...
                                                                <td>
                                                <a class="btn btn-primary btn-sm" href="{{route('wards.edit',$ward->id)}}"><i class="fa fa-edit" title="Edit"></i> </a>
                                                 <a id="delete" class="btn btn-danger btn-sm" href="{{route('wards.delete',$ward->id)}}"><i class="fa fa-trash" title="Delete"></i> </a>
                                                                </td>
                                                            </tr>
                                                            @endforeach
                                                        </tbody>
