    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-xs-12">
            <div class="col-lg-6 entry_panel_body ">
                <a href="{{route('customers.add')}}"><input type="button" value="+ Add Customer" class="col-lg-offset-9 col-lg-3 col-md-offset-9 col-md-3 col-sm-offset-9 col-sm-3 col-xs-offset-7 col-xs-3 btn btn-sm button btn-primary pull-left" style="font-size: 12px; font-weight: bold;"></a>
            ...
            <table id="example1" name="example1" class="stripe row-border order-column" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a  class="btn btn-primary btn-sm" href="{{route('customers.edit',$customer->id)}}"><i class="fa fa-edit" title="Edit">Edit</i> </a>
                            <a id="delete" class="btn btn-danger btn-sm" href="{{route('customers.delete',$customer->id)}}"><i class="fa fa-trash" title="Delete">Edit</i> </a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
